...
const Footer = () => {
    ...
    return (
        <footer className=" w-full bg-primary-light flex flex-col items-center gap-3 pt-16 mt-12">
            ...
            <p className=" text-primary-faded font-normal text-lg text-center">Shop internationally, receive your items in Nigeria. Simply, <br className="hidden lg:block" /> safely, and transparently.</p>
            ...
            <div className="flex w-full justify-center py-5 border-t border-primary-faded">
                <p className=" text-white font-normal text-lg text-center">© 2024 YourPlatformName. All rights reserved.</p>
            </div>
        </footer>
    )
}
