...
const PlatformHighlights = () => {
    ...
    return (
        <section className=" flex flex-col py-12 mx-auto max-w-7xl px-5 sm:px-0">
            ...
            <h2 className=' text-3xl sm:text-5xl/16 text-grey font-medium text-center'>Everything You Need, In One Place</h2>
            <p className=' text-center font-normal text-sm sm:text-base/6 text-grey-light my-2'>Everything You Need, In One Place</p>
