...
const PopularStores = () => {
    ...
    return (
        <section className=" flex flex-col py-12 mx-auto max-w-7xl px-5 sm:px-0">
            ...
            <h2 className=' text-3xl sm:text-5xl/16 text-grey font-medium text-center'>Top Stores Nigerians Shop From</h2>
            <p className=' text-center font-normal text-sm sm:text-base/6 text-grey-light my-2'>Shop from trusted international brands across fashion, electronics, home, and more. We <br className="hidden lg:block" /> handle the delivery from abroad and bring your items safely to Nigeria.</p>
