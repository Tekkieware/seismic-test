...
const Hero = () => {
    return (
        <section className=" flex flex-col items-center justify-center py-12">
            ...
            <p className=' text-base font-normal text-grey text-center'>We help <b>Nigerians shop from abroad,</b> receive items at our overseas warehouse, and <br /> <b>ship them safely to Nigeria,</b> with clear pricing and full tracking.</p>
