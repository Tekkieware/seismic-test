...
const BuiltForYou = () => {
    ...
    return (
        <section className=" flex flex-col py-12 mx-32">
            ...
            <h2 className=' text-5xl/16 text-grey font-medium text-center'>Who Is This For?</h2>
            <p className=' text-center font-normal text-base/6 text-grey-light my-2'>Designed for Nigerians who shop internationally and want reliable<br className="hidden lg:block" /> delivery back home.</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 my-5">
                <SecondaryCard className='self-start'>
                    <div className="w-full items-center justify-center min-h-35 ">
                         <div className=" p-5 flex flex-col gap-2">
                            <h3 className=' text-grey font-bold text-2xl'>Small Business Owners</h3>
                            <p className=' text-grey-light font-normal text-base'>Importing items for resale in Nigeria.</p>
                        </div>
                ...
                <div className=" bg-red-50 mt-22">
                    ...
                    <div className="w-full items-center justify-center min-h-35">
                        ...
                        <div className=" p-5 flex flex-col gap-2">
                            <h3 className=' text-grey font-bold text-2xl'>Everyday Shoppers</h3>
                            <p className=' text-grey-light font-normal text-base'>Buying clothes, gadgets, and accessories from abroad.</p>
                        </div>
                    </div>
                </SecondaryCard>
                </div>
