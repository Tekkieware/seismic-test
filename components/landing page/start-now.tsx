        ...
        <section className=" flex flex-col py-12 mx-auto max-w-7xl items-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="flex flex-col gap-5 justify-center">
                    <h1 className="text-grey font-black text-bold-caption/16 max-w-4xl py-3">
                        Start Shipping From
                        <br className="hidden lg:block" />
                        Abroad Without Stress
                    </h1>
                    <p className=' font-normal text-grey-light text-base'>Shop internationally with confidence and receive your items <br className="hidden lg:block" /> in Nigeria with ease.</p>
                    <div className="">
