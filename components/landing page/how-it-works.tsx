                    ...
                    <div className="flex flex-col gap-2  self-start">
                        <SecondaryCard className='py-3 px-5 rounded-full border-none bg-white'>
                            <div className="flex justify-between items-center">
                                ...
                                <span className=' text-primary border text-xl border-primary rounded-full py-2 px-3 border-dashed'>01</span>
                            </div>

                        </SecondaryCard>
                        <SecondaryCard className='p-8 pt-30 border-none bg-white'>
                            <div className="flex flex-col gap-2">
                                <h1 className='font-bold text-2xl text-grey'>Shop Online</h1>
                                <span className=' text-grey-light text-base font-normal'>Buy items from international stores that ship to our overseas warehouse.</span>
                            </div>
                        </SecondaryCard>
                    </div>
                    <svg
                    ...
                    <div className="flex flex-col gap-2  justify-self-end sm:mt-45">
                        <SecondaryCard className='py-3 px-5 rounded-full border-none bg-white'>
                            <div className="flex justify-between items-center">
                                ...
                                <span className=' text-primary border text-xl border-primary rounded-full py-2 px-2.5 border-dashed'>02</span>
                            </div>

                        </SecondaryCard>
                        <SecondaryCard className='p-8 pt-30 border-none bg-white'>
                            <div className="flex flex-col gap-2">
                                <h1 className='font-bold text-2xl text-grey'>We Receive Your Item</h1>
                                <span className=' text-grey-light text-base font-normal'>Your order arrives at our shared overseas warehouse, where it is checked in and prepared for shipping.</span>
                            </div>
                        </SecondaryCard>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 sm:mt-45">
                        <SecondaryCard className='py-3 px-5 rounded-full border-none bg-white'>
                            <div className="flex justify-between items-center">
                                ...
                                <span className=' text-primary border text-xl border-primary rounded-full py-2 px-2.5 border-dashed'>04</span>
                            </div>

                        </SecondaryCard>
                        <SecondaryCard className='p-8 pt-30 border-none bg-white'>
                            <div className="flex flex-col gap-2">
                                <h1 className=' font-bold text-2xl text-grey'>Delivered to Nigeria</h1>
                                <span className=' text-grey-light text-base font-normal'>Your package is shipped to Nigeria and delivered to your address, with tracking updates along the way.</span>
                            </div>
                        </SecondaryCard>
                    </div>
                    <svg
                    ...
                    <div className="flex flex-col gap-2 justify-self-end self-start">
                        <SecondaryCard className='py-3 px-5 rounded-full border-none bg-white'>
                            <div className="flex justify-between items-center">
                                ...
                                <span className=' text-primary border text-xl border-primary rounded-full py-2 px-2.5 border-dashed'>03</span>
                            </div>

                        </SecondaryCard>
                        <SecondaryCard className='p-8 pt-30 border-none bg-white'>
                            <div className="flex flex-col gap-2">
                                <h1 className=' font-bold text-2xl text-grey'>Choose Shipping & Pay</h1>
                                <span className=' text-grey-light text-base font-normal'>Select your shipping option, view the cost, and complete payment.</span>
                            </div>
                        </SecondaryCard>
                    </div>
